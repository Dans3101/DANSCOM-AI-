...
export const processCommand = async (
  ...
  try {
    const { handleEcosystemCommand } = await import('../utils/advancedEcosystem.js');
    const wasHandled = await handleEcosystemCommand(sock, m, command, args, context);
    if (wasHandled) {
      return;
    }
  } catch (error: any) {
    console.error('[Ecosystem Command Error]:', error);
  }
...
━━━━━━━━━━━━━━━━━━━━━━`;
      ...
      case 'createagent': {
        ...
        break;
            ...
            // ===================================================
      // MENU NAVIGATION CASES 1–31 (FIXED - NO DUPLICATES)
      // ===================================================
      case '1':
      case '2':
      case '3':
...
│ .claude    - Claude AI Mode    │
│ .copilot   - Copilot AI Mode   │
│ .bard      - Bard AI Mode      │
│ .blackbox  - Blackbox AI       │
│ .essay     - Write an Essay    │
│ .essayai   - AI Essay Writer   │
│ .story     - Generate Story    │
│ .poem      - Write a Poem      │
│ .code      - Generate Code     │
│ .codeai    - AI Code Helper    │
│ .fix       - Fix My Code       │
│ .explain   - Explain Topic     │
│ .summarize - Summarize Text    │
│ .rewrite   - Rewrite Text      │
│ .roast     - AI Roast Me       │
│ .translateai - AI Translator   │
│ .lyricsai  - AI Lyrics Writer  │
│ .musicai   - AI Music Composer │
│ .videoai   - AI Video Director │
│ .voiceai   - AI Voice Actor    │
└────────────────────────┘`,
...
│ .imageai   - AI Image Engine   │
│ .photoai   - AI Photo Engine   │
│ .animeai   - AI Anime Art      │
│ .logoai    - AI Logo Maker     │
│ .enhance   - Enhance Photo     │
│ .removebg  - Remove BG         │
│ .cartoon   - Cartoonify Photo  │
│ .sticker   - Make Sticker      │
│ .meme      - Create Meme       │
│ .colorize  - Color Old Photo   │
│ .crop      - Crop Image        │
│ .resize    - Resize Image      │
│ .filter    - Apply Filter      │
...
│ .autoread   - Auto Read Msgs   │
│ .autotyping - Auto Typing      │
│ .autorecord - Auto Recording   │
│ .autostatus - Auto View Status │
│ .autostatuslike - Auto Like    │
│ .chatbot    - AI Smart Reply   │
│ .anticall   - Block Auto Calls │
│ .antidelete - Save Del. Msgs   │
│ .public     - Set Public Mode  │
│ .private    - Set Private Mode │
│ .enable     - Enable Feature   │
│ .disable    - Disable Feature  │
│ .mode       - Toggle Bot Mode  │
...
│ .bass      - Bass Boost Filter │
│ .slow      - Slow Reverb Filter│
...
│ .fancy     - Fancy Text Style  │
│ .style     - Style Text        │
│ .obfuscate - Obfuscate Text    │
│ .readmore  - Read More Effect  │
...
║  📰  *12. NEWS MENU*  🆕  ║
╚════════════════════════╝
│ .news      - Latest Top News   │
│ .breaking  - Breaking News     │
│ .sportnews - Sports News       │
│ .technews  - Tech News         │
│ .biznews   - Business News     │
│ .worldnews - World News        │
│ .enews     - Entertainment     │
│ .healthnews- Health News       │
│ .localnews - News by Region    │
...
│ .continent - Continent Facts   │
│ .about     - About DANSCOM Bot │
│ .faq       - FAQ & Help        │
│ .rules     - Bot Rules         │
...
│ .diet       - Diet Advice      │
│ .sleep      - Sleep Tips       │
│ .meditate   - Meditation Guide │
│ .calories   - Calorie Checker  │
│ .symptom    - Symptom Checker  │
│ .mentalhealth - Mental Tips    │
│ .heartrate  - Heart Rate Guide │
...
│ .meal      - Meal Planner      │
│ .foodfact  - Food Fun Facts    │
│ .dessert   - Dessert Ideas     │
│ .drink     - Drink Recipes     │
│ .cuisine   - Cuisine by Country│
...
║  🗺️ *18. TRAVEL MENU* 🆕 ║
╚════════════════════════╝
│ .countryinfo - Country Guide   │
│ .country     - Country Info    │
│ .visa        - Visa Info       │
│ .timezone    - Time Converter  │
│ .phrase      - Local Phrases   │
│ .currency    - Currency Conv.  │
│ .hotel       - Find Hotels     │
│ .maps        - Get Directions  │
│ .warning     - Travel Warning  │
...
│ .igstalk    - Instagram Profile│
│ .ttstalk    - TikTok Profile   │
│ .ytstalk    - YouTube Profile  │
│ .telegramstalk - Telegram Info │
│ .ghstalk    - GitHub Profile   │
│ .gitstalk   - Git Stalk        │
│ .npmstalk   - NPM Package Info │
│ .github     - GitHub Directory │
│ .movieinfo  - Movie/Show Info  │
│ .spotifysearch - Spotify Search│
...
│ .clearchats - Clear Cache      │
│ .setcmd     - Add Command      │
│ .delcmd     - Delete Command   │
│ .eval       - Run Code         │
│ .exec       - Run Terminal Cmd │
│ .getfile    - Read Server File │
│ .save       - Save Server File │
...
│ .subscribe   - Subscribe Chan. │
│ .unsubscribe - Unsubscribe     │
│ .post        - Post Update     │
│ .updates     - View Updates    │
│ .announcement- Make Announce.  │
│ .poll        - Create Poll     │
│ .pin         - Pin Message     │
│ .unpin       - Unpin Message   │
│ .reaction    - Channel Stats   │
│ .views       - View Count      │
...
│ .unpremium  - Cancel Premium   │
│ .donate     - Support Dev      │
│ .contact    - Contact Owner    │
└────────────────────────┘`,

          // ─────────────────────────────────────────
          // 30. CLOUD STORAGE & OS APPS
          // ─────────────────────────────────────────
          '30': `╔════════════════════════╗
║  📁 *30. CLOUD STORAGE*   ║
╚════════════════════════╝
...
└────────────────────────┘`
        ...
        const menuText = menus[command] || `⚠️ Menu *${command}* is not yet implemented. Type *.menu* to see all options.`;
        await sock.sendMessage(from, { text: menuText }, { quoted: m });
        break;
      }
      // ===================================================
      // END OF MENU NAVIGATION CASES
      // ===================================================
...
5. *Aston Villa* - 65 pts`;
      ...
      case 'anticall': {
        ...
        const featMap: Record<string, string> = {
          ...
          'autostatuslike': 'auto_status_like',
