      ...
      <header className="h-16 bg-slate-900 border-b border-slate-800 px-8 flex items-center justify-between flex-shrink-0 select-none">
        ...
        <div className="flex items-center gap-4">
          <a 
            ...
            download="DANSCOM_System_Specification.pdf"
            className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-900 border border-slate-800 text-white hover:bg-slate-800 rounded-xl transition-all text-[11px] font-bold tracking-wide uppercase select-none cursor-pointer"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.2} stroke="currentColor" className="w-3.5 h-3.5 text-indigo-400">
